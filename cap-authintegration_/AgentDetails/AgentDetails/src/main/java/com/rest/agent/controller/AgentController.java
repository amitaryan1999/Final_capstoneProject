...
public class AgentController {
	...
	public ResponseEntity<?> addAgentHandler(@RequestParam("agentName") String agentName,
			@RequestParam("agentPassoword") String agentPassoword, @RequestParam("agentMobile") String agentMobile,
			@RequestParam("agentEmail") String agentEmail, @RequestParam("agentAddress") String agentAddress,
