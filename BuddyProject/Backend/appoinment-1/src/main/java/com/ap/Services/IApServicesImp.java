...
//        	Extracting the user details as user object from optional
	...
	private boolean isSlotsAvailable(String appointSlots,String appointDate) {
		Optional<apUser> appointOptional = appointrepo.findByDate(appointDate,appointSlots);
		boolean status=true;
		if(appointOptional.isPresent()) {
