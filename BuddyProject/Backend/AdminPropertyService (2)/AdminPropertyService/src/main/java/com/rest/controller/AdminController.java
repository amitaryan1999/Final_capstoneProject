...
//	http://localhost:8085/api/property/addProperty
	...
	public ResponseEntity<?> savePropertyHandler(@RequestParam("property_name") String property_name, @RequestParam("desc") String desc, @RequestParam("category") String category, @RequestParam("bedroom") int bedroom,
			@RequestParam("bathroom") int bathroom, @RequestParam("parking") boolean parking, @RequestParam("area") int area, @RequestParam("year_build") String year_build, @RequestParam("location") String location,
			@RequestParam("agentName") String agentName, @RequestParam("buy") boolean buy, @RequestParam("rent") boolean rent,@RequestParam("buyPrice") double buyPrice,@RequestParam("rentPrice") double rentPrice,@RequestParam("balcony") boolean balcony,@RequestParam("deck") boolean deck,@RequestParam("cableTV") boolean cableTV,@RequestParam("pool") boolean pool,@RequestParam("video") String video, @RequestParam(value="image") MultipartFile image, Model model) throws IOException {
	...
	public ResponseEntity<?> updatePropertyHandler(@RequestParam("property_name") String property_name, @RequestParam("desc") String desc, @RequestParam("category") String category, @RequestParam("bedroom") int bedroom,
			@RequestParam("bathroom") int bathroom, @RequestParam("parking") boolean parking, @RequestParam("area") int area, @RequestParam("year_build") String year_build, @RequestParam("location") String location,
			@RequestParam("agentName") String agentName, @RequestParam("buy") boolean buy, @RequestParam("rent") boolean rent,@RequestParam("buyPrice") double buyPrice,@RequestParam("rentPrice") double rentPrice,@RequestParam("balcony") boolean balcony,@RequestParam("deck") boolean deck,@RequestParam("cableTV") boolean cableTV,@RequestParam("pool") boolean pool,@RequestParam("video") String video, @RequestParam(value="image", required = false) MultipartFile image, @PathVariable String uid, Model model) throws IOException
	{
		UserProperty property = new UserProperty(property_name, desc, category, bedroom, bathroom,parking,
				area, year_build, location, agentName, buy, rent,
				buyPrice, rentPrice, balcony, deck, cableTV, pool,video);
